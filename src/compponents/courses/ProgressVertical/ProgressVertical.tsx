	...
	const handleCalculateProgressToBeAdded = useCallback(
		(
			...
			const currentAnimatedIndex =
				handleGetIndexFromThreshold(targetCurrent);
			const chapterElements =
				handleGetChapterElements(currentAnimatedIndex);
					...
					>
						...
						{index + 1 < milestones.length && (
							<div
								...
								className={clsx(
									"Course_nextProgress absolute w-1.5"
								)}
								style={{
						...
						<ProgressMilestone
							indexText={
								indexTemplate && indexTemplate(index + 1)
							}
							title={chapter}
